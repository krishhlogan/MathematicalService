...
class AlgorithmsTest(TestCase):
    def test_fibonacci_valid_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/fibonacci/', data={'number': 10})
    ...
    def test_fibonacci_invalid_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/fibonacci/', data={'number': "10zx"})
    ...
    def test_fibonacci_large_number(self):
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/fibonacci/', data={'number': 1000})
        self.assertEqual(response.status_code, 200)
        response = response.json()
    ...
    def test_factorial_valid_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/factorial/', data={'number': 5})
        self.assertEqual(response.status_code, 200)
        result = int(response.json()['result'])
    ...
    def test_factorial_invalid_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/factorial/', data={'number': "10zx"})
        self.assertEqual(response.status_code, 400)
        response = response.json()
        self.assertEqual(response['status'], False)
    ...
    def test_factorial_negative_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/factorial/', data={'number': -10})
        self.assertEqual(response.status_code, 400)
        response = response.json()
        self.assertEqual(response['status'], False)
    ...
    def test_factorial_large_number(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/factorial/', data={'number': 1000})
        self.assertEqual(response.status_code, 200)
        response = response.json()
        import math
    ...
    def test_ackermann_valid_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/ackermann/', data={'m': 4, 'n': 1})
        self.assertEqual(response.status_code, 200)
        result = int(response.json()['result'])
    ...
    def test_ackermann_invalid_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/ackermann/', data={'m': "10zx", 'n' : 1})
        self.assertEqual(response.status_code, 400)
        response = response.json()
        self.assertEqual(response['status'], False)
    ...
    def test_ackermann_negative_input(self):
        ...
        response = self.client.post(path='http://127.0.0.1:8000/algorithm/ackermann/', data={'m': -10, 'n':1})
        self.assertEqual(response.status_code, 400)
        response = response.json()
        self.assertEqual(response['status'], False)
